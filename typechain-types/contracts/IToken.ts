...
export interface IToken extends BaseContract {
  ...
  borrow: TypedContractMethod<[amount: BigNumberish], [boolean], "nonpayable">;

  borrows: TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
  ...
  redeem: TypedContractMethod<[amount: BigNumberish], [boolean], "nonpayable">;

  repay: TypedContractMethod<[amount: BigNumberish], [boolean], "nonpayable">;
